 ...
 */
@Configuration
@EnableConfigurationProperties(top.daoha.config.RedisClientConfigProperties.class)
public class RedisClientConfig {

    @Bean("redissonClient")
    @Primary
    @ConditionalOnMissingBean(RedissonClient.class)
    public RedissonClient redissonClient(ConfigurableApplicationContext applicationContext, top.daoha.config.RedisClientConfigProperties properties) {
